...
CREATE UNIQUE INDEX "app_workout_templates_user_id_seed_slug_unique_idx" ON "app_workout_templates" USING btree ("user_id","seed_slug") WHERE "app_workout_templates"."seed_slug" is not null;--> statement-breakpoint
